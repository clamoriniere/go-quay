...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["image","application","null"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// NewRepoRepoKindNull captures enum value "null"
	NewRepoRepoKindNull string = "null"
)

// prop value enum
func (m *NewRepo) validateRepoKindEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, newRepoTypeRepoKindPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *NewRepo) validateVisibilityEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, newRepoTypeVisibilityPropEnum, true); err != nil {
		return err
	}
	return nil
}
