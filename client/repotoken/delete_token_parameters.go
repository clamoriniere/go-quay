...
// SetCode adds the code to the delete token params
func (o *DeleteTokenParams) SetCode(code string) {
	o.Code = code
}
...
// SetRepository adds the repository to the delete token params
func (o *DeleteTokenParams) SetRepository(repository string) {
