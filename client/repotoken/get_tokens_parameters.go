...
// SetCode adds the code to the get tokens params
func (o *GetTokensParams) SetCode(code string) {
	o.Code = code
}
...
// SetRepository adds the repository to the get tokens params
func (o *GetTokensParams) SetRepository(repository string) {
