...
func (o *ListRepoTagsParams) WithOnlyActiveTags(onlyActiveTags *bool) *ListRepoTagsParams {
	o.SetOnlyActiveTags(onlyActiveTags)
	return o
}
...
func (o *ListRepoTagsParams) SetOnlyActiveTags(onlyActiveTags *bool) {
	o.OnlyActiveTags = onlyActiveTags
}
...
func (o *ListRepoTagsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.OnlyActiveTags != nil {

		// query param onlyActiveTags
		var qrOnlyActiveTags bool
		if o.OnlyActiveTags != nil {
			qrOnlyActiveTags = *o.OnlyActiveTags
		}
		qOnlyActiveTags := swag.FormatBool(qrOnlyActiveTags)
		if qOnlyActiveTags != "" {
			if err := r.SetQueryParam("onlyActiveTags", qOnlyActiveTags); err != nil {
				return err
			}
		}
